...
>
> A base para o desenvolvimento deste projeto foi o projeto do CP2, cujo repositório
> está disponível em [github.com/Andrei-Gibbini/LojaTintas](https://github.com/Andrei-Gibbini/LojaTintas).
> Foi necessário adaptar o projeto para um novo tema, pois o integrante que saiu do
> grupo permaneceu com o tema original (loja de tintas).
